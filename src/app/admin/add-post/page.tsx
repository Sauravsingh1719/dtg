...
export default function AddPost({ onSuccess }: AddPostProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => { // Specify the type for the event parameter
    e.preventDefault();
    
    const createdAt = new Date().toISOString(); 
    const finalCategory = newCategory ? newCategory : category; // Use new category if provided
